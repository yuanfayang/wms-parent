...
public class CellInfoServiceImpl extends AbstractService<CellInfo, Integer> implements CellInfoService {
    ...
    @Override
    public List<CellInfoDto> findListByRowColumn(CellInfoCriteriaRowColumn criteria){
    	 return cellInfoMapper.findListByRowColumn(criteria);
    }
	...
	@Override
	public int findRollCountByCellCode(@Param("cellCode") String cellCode) {

		return cellInfoMapper.findRollCountByCellCode(cellCode);
	}

    @Override
    public List<CellInfoDto> findListNew(CellInfoParams params) {
        return cellInfoMapper.findListNew(params);
    }

    @Override
    public List<CellInfoDto> findListByRowColumnNew(CellInfoParamsRowColumn params) {
        return cellInfoMapper.findListByRowColumnNew(params);
    }

    @Override
    public void deleteByShelfId(ShelfInfoParams params) {
