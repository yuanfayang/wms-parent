...
public class ShelfInfoServiceImpl extends AbstractService<ShelfInfo, Integer> implements ShelfInfoService {
    ...
    @Override
    public List<ShelfInfoDto> findListNew(ShelfInfoParams params) {
        return shelfInfoMapper.findListNew(params);
    }

    @Override
    public void deleteByIdAndComNew(ShelfInfoParams params) {
        shelfInfoMapper.deleteByIdAndComNew(params);
    }

    @Override
    public Integer countNoEmptyCells(ShelfInfoParams params) {
        return shelfInfoMapper.countNoEmptyCells(params);
    }
