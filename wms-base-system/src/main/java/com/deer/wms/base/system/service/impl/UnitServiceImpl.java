...
public class UnitServiceImpl extends AbstractService<Unit, Integer> implements UnitService {
    ...
    @Override
    public List<Unit> findListNew(UnitParams params) {
        return unitMapper.findListNew( params);
    }

    @Override
    public void deleteByIdAndCom(UnitParams params) {
        unitMapper.deleteByIdAndCom(params);
    }

    @Override
    public Integer countRelProducts(UnitParams params) {
        return unitMapper.countRelProducts(params) ;
    }
