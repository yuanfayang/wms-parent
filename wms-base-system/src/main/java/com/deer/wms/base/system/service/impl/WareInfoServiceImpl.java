...
public class WareInfoServiceImpl extends AbstractService<WareInfo, Integer> implements WareInfoService {
    ...
    @Override
    public List<WareInfoDto> findListNew(WareInfoParams params) {
        return wareInfoMapper.findListNew(params);
    }

    @Override
    public Integer countChildren(WareInfoParams params) {
        return wareInfoMapper.countChildren(params);
    }

    @Override
    public void deleteByIdAndCom(WareInfoParams params) {
        wareInfoMapper.deleteByIdAndCom(params);
    }
