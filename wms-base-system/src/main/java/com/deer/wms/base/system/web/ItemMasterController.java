...
import com.deer.wms.base.system.model.ItemMasterParams;
...
public class ItemMasterController {
    ...
    public Result listNew(ItemMasterParams params, @ApiIgnore @User CurrentUser currentUser) {
        if(currentUser==null){
        ...
        List<ItemMasterDto> list = itemMasterService.findListNew(params);
        PageInfo pageInfo = new PageInfo(list);
        return ResultGenerator.genSuccessResult(pageInfo);
    }
