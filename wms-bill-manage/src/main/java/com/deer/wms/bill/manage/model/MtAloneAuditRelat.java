...
@Table(name = "mt_alone_audit_relat")
public class MtAloneAuditRelat {
    @Id
    ...
    /**
     * 获取是否审核完成，0：代审核，1：审核结束
     *
     * @return is_audit - 是否审核完成，0：代审核，1：审核结束
     */
    ...
    /**
     * 设置是否审核完成，0：代审核，1：审核结束
     *
     * @param isAudit 是否审核完成，0：代审核，1：审核结束
     */
