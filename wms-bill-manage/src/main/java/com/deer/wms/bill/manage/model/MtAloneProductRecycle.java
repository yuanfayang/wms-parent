...
@Table(name = "mt_alone_product_recycle")
public class MtAloneProductRecycle {
    @Id
     ...
     * 获取绑定入库单code
     *
     * @return inbound_order_code - 绑定入库单code
     */
