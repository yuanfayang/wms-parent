...
public class BillDetailController {
    ...
    @OperateLog(description = "新增billDetail以及billMaster列表", type = "新增")
    ...
    @OperateLog(description = "根据id删除billDetail列表", type = "删除")
    @ApiImplicitParams({
            @ApiImplicitParam(name = "access-token", value = "token", paramType="header", dataType="String", required = true)
    })
    @GetMapping("/delete")
    ...
    @OperateLog(description = "更新billDetail", type = "更新")
    ...
    @OperateLog(description = "查询页面BillDetail列表", type = "查询")
    @ApiOperation(value = "查询页面List", notes = "查询页面List")
    @ApiImplicitParams({
            @ApiImplicitParam(name = "access-token", value = "token", paramType="header", dataType="String", required = true)
    })
    @GetMapping("list")
