...
public class CodeGenerator {
    public static void main(String[] args) {
        ...
        //设置需要生成的表
        configurer.getTables().add(new Table("mt_alone_detect_det", null, "detect_id", "Integer"));
//        configurer.getTables().add(new Table("mt_alone_product", null, "product_id", "Integer"));
