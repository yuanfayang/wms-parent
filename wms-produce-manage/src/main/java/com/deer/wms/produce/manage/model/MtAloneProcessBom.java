...
public class MtAloneProcessBom {
    @Id
    ...
    /**
     * 工序执行部门  管理mt_alone_department
     */
    @Column(name = "process_apartment")
    ...
    /**
     * 获取工序执行部门  管理mt_alone_department
     *
     * @return process_apartment - 工序执行部门  管理mt_alone_department
     */
    ...
    /**
     * 设置工序执行部门  管理mt_alone_department
     *
     * @param processApartment 工序执行部门  管理mt_alone_department
     */
