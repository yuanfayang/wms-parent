...
public class PermissionServiceImpl extends AbstractService<Permission, Integer> implements PermissionService {
	...
	@Override
	public List<MtAloneRoute> findPermissionRoutesByUserId(Integer userId) {
		// TODO Auto-generated method stub
		return permissionMapper.findPermissionRoutesByUserId(userId);
	}

    @Override
    public List<PermissionTreeModel> findPermissionTreeFormListRoleDetailNew(RoleParams params) {
        List<PermissionTreeModel> list = permissionMapper.findPermissionTreeFormListRoleDetailNew(params);
        return list;
    }
}
