...
public class RoleServiceImpl extends AbstractService<Role, Integer> implements RoleService {
	...
	@Override
	public List<RoleListVO> findRoleListNew(RoleParams params) {
		return roleMapper.findRoleListNew(params);
	}

    @Override
    public RoleDetailVO findRoleDetailNew(RoleParams params) {
        RoleDetailVO vo = roleMapper.selectRoleByRoleId(params.getRoleId());
        vo.setTreeList(permissionService.findPermissionTreeFormListRoleDetailNew(params));
        return vo;
    }
}
