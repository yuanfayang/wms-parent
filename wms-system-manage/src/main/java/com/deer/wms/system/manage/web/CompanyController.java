...
public class CompanyController {
    ...
    @GetMapping("/list/new")
    public Result getCompanyListNew(CompanyInfoParams params, @ApiIgnore @User CurrentUser currentUser) {
        if(currentUser==null){
        ...
        List<CompanyListVO> voList = companyService.findCompanyFormListNew(params);
        PageInfo pageInfo = new PageInfo(voList);
        return ResultGenerator.genSuccessResult(pageInfo);
    }
    ...
    @PostMapping()
    public Result createCompany(@RequestBody CompanyCreate create, HttpServletRequest request, @ApiIgnore @User CurrentUser currentUser) {
        ...
        create.setCompanyType(SystemManageConstant.COMPANY_TYPE_SUPPLIER); 
    ...
    public Result modifyCompany(@PathVariable Integer companyId, @RequestBody CompanyModify modify, HttpServletRequest request, @ApiIgnore @User CurrentUser currentUser) {
    	System.out.println(modify.getCompanyName());
    	CompanyCriteria criteria = new CompanyCriteria();
    	criteria.setPageNum(null);
        criteria.setPageSize(null);
        List<CompanyListVO> voList = companyService.findCompanyFormList(criteria);
