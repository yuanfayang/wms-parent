...
//
//public class IpDemo implements Runnable, SerialPortEventListener {
//
//    public static void main(String[] args) {
//        // 测试ip 221.232.245.73 湖北武汉
//        String ip = "121.237.97.159";
//        Map address  = IpDemo.getAddresses("ip="+ip, "utf-8");
//        ip =address.get("ip").toString();
...
//        String returnStr = IpDemo.getResult(urlStr, content, encodingString);
//        if (returnStr != null) {
//            // 处理返回的省市区信息
...
//                switch (i) {    //IP
//                    case 1:
//                        ip = (temp[i].split(":"))[2].replaceAll("\"", "");
//                        ip = decodeUnicode(ip);            // ip
//                        break;
//
//                    case 2:
...
//                        county = decodeUnicode(county);            // 城区
//                        break;
//                    case 7:    //电信
